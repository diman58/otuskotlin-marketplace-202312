...
import org.example.com.otus.otuskotlin.hub.logging.socket.SocketLoggerSettings
import org.example.com.otus.otuskotlin.hub.logging.socket.mpLoggerSocket
    ...
    fun socketTest() = runTest(timeout = 3.seconds) {
        ...
        withContext(Dispatchers.Default) {
            ...
            mpLoggerSocket("test", loggerSettings).use { logger ->
                ...
                while ((logger as? HubLoggerWrapperSocket)?.isReady?.value != true) {
                    delay(1)
                }
                coroutineScope {
                    launch {
